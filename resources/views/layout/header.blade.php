        ...
        <div class="header-left">
            ...
            <div class="header-info-content">
                ...
                <div class="status-info text-center"">
                  ...
                  <br>
                  <small>( Inertia React js + Laravel )</small>
               </div>
               <!-- social sharea area -->
    ...
    <div class="col-lg-6">
        <div class="header-right">
            <ul class="rn-header-content">
                <li><span class="overhead">EMAIL</span>yogahendriansyah@gmail.com</li>
                <li><span class="overhead">PHONE</span>+628-13-8181-9011</li>
            </ul>
